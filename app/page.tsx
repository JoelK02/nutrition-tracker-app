    ...
    <>
      <div className="bg-green-50 p-4 flex justify-between items-center border-b">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="p-2 text-gray-600 hover:bg-green-100 rounded-full">
            <FaCog />
          </button>
          <button className="p-2 text-gray-600 hover:bg-green-100 rounded-full">
            <FaBell />
      ...
      <div className="p-8 ">
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4 text-gray-800 text-center">Nutrient Summary</h2>
          <NutrientDonut />
        </div>

        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">Recently Consumed</h2>
